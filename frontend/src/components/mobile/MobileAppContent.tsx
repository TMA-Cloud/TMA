      ...
      <header className="relative px-4 py-3 flex items-center justify-between bg-white/95 dark:bg-slate-900/95 backdrop-blur-xl border-b border-gray-200/50 dark:border-slate-800/50 shadow-sm z-[9999]">
        <div className="flex items-center space-x-2">
          ...
          <div className="flex flex-col">
            <span className="text-sm font-semibold text-gray-900 dark:text-gray-100">CloudStore</span>
            <span className="text-[11px] text-gray-500 dark:text-gray-400">{currentPage}</span>
          </div>
        </div>
              ...
              >
                ...
                <span
                  className={`mt-0.5 text-[10px] font-medium transition-colors duration-200 ${
                    active ? 'text-blue-600 dark:text-blue-400 font-semibold' : 'text-gray-500/80 dark:text-gray-400/80'
                  }`}
                >
                  {item.label}
                </span>
