...
export const ContextMenu: React.FC<ContextMenuProps> = ({
  ...
  // - Image files (image/*), video files (video/*), and audio files (audio/*)
    ...
    return (
      <>
        ...
        >
          <div
            ref={menuRef}
            className="bg-[#ffffff]/98 dark:bg-slate-800/95 backdrop-blur-xl rounded-t-2xl shadow-2xl pt-3 pb-4 px-4 max-h-[70vh] overflow-y-auto animate-slideUp"
  ...
  const desktopMenu = (
    <div
      ref={menuRef}
      className="fixed z-50 bg-[#ffffff]/98 dark:bg-slate-800/95 backdrop-blur-xl border border-gray-200/50 dark:border-slate-700/50 rounded-2xl shadow-2xl py-2 min-w-48 focus:outline-none"
      style={{
        left: `${menuStyle.x}px`,
        top: `${menuStyle.y}px`,
