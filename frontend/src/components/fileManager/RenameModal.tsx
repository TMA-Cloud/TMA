      ...
      >
        <div>
          ...
          <input
            ...
            ref={inputRef}
            className="w-full px-3 py-2 border border-gray-300 dark:border-gray-600 rounded-lg bg-[#ffffff] dark:bg-gray-700 focus:outline-none focus:ring-2 focus:ring-blue-500"
            autoFocus
          />
        </div>
