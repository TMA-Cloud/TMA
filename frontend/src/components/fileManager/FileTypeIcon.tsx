...
export const FileTypeIcon: React.FC<{
  ...
  const style =
    extension && (defaultStyles as Record<string, object>)[extension];
  ...
  const imageVideoOverrides: Record<
    string,
    { color: string; labelColor: string; glyphColor: string }
  > = {
    image: {
      color: "#7C3AED",
      labelColor: "#5B21B6",
